...
def start
  ...
  if CDCDataExtraction == 1
    ...
    FasterCSV.open( file, 'w' ) do |csv|
      csv << ["Facility_Name", "Category","Total of Category","Less_than_1_yr", "Between_1_and_9_yrs", "Between_10_14_yrs_female", "Between_10_14_yrs_male", "Between_15_19_yrs_female", "Between_15_19_yrs_male", "Between_20_24_yrs_female", "Between_20_24_yrs_male", "Between_25_49_yrs_female", "Between_25_49_yrs_male", "More_than_50_yrs_female", "More_than_50_yrs_male", "Less_than_15_year_female", "Less_than_15_year_male", "More_than_15_years_female", "More_than_15_years_male"]
      ...
      csv << ["#{facility_name}", "Receving ART (Total registered- Cumulative)","#{total_receiving_art_cumulative}", "#{receiving_art_cumulative_less_1}", "#{receiving_art_cumulative_between_1_and_9}", "#{receiving_art_cumulative_btwn_10_14_female}", "#{receiving_art_cumulative_btwn_10_14_male}", "#{receiving_art_cumulative_less_15_19_female}", "#{receiving_art_cumulative_less_15_19_male}", "#{receiving_art_cumulative_less_20_24_female}", "#{receiving_art_cumulative_less_20_24_male}", "#{receiving_art_cumulative_less_25_49_female}", "#{receiving_art_cumulative_less_25_49_male}", "#{receiving_art_cumulative_less_more_than_50_female}", "#{receiving_art_cumulative_less_more_than_50_male}", "#{receiving_art_cumulative_less_15_female}", "#{receiving_art_cumulative_less_15_male}", "#{receiving_art_cumulative_more_15_female}", "#{receiving_art_cumulative_more_15_male}"]
      ...
      csv << ["Facility_Name", "PEADs with outcomes","Children_less_15yrs(Cumulative)", "Patients Alive and on ARVs(All ages)", "Children_less_15_years(Alive and on ARVs)", "Children_between_10_and_14yrs(Alive and on ARvs)", "Children_14yrs_only(Alive and on ARvs)", "Patients_between_15_and_19yrs(Alive and on ARvs)", "Patients_more_than_20yrs(Alive and on ARvs)", "Died_children_less_15yrs", "Defaulted_children_less_15yrs", "Treatment_stopped_children_less_15yrs", "Transferred_out_children_less_15yrs"]
